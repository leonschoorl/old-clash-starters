...
- [Project overview](#project-overview)
  - [my-clash-project-nul-zeven.cabal](#namecabal)
...
│   └── unittests.hs
├── cabal.project
├── my-clash-project-nul-zeven.cabal
└── stack.yaml
```
...
Note: If you need a newer Clash version, simply change the version bounds in `my-clash-project-nul-zeven.cabal` and follow the hints given by Stack.

## src/
This is where the source code of the project lives, as specified in `my-clash-project-nul-zeven.cabal`. It contains a single file, `Example/Project.hs` which starts with:
...
# Change the license
By default `my-clash-project-nul-zeven.cabal` sets its `license` field to `BSD-2-Clause`. You might want to change this.
